...
OpenLayers.Lang["zh-hans"] = OpenLayers.Util.applyDefaults({
    ...
    'getFeatureError': "getFeatureFromEvent方法在一个没有渲染器的图层上被调用。 这通常意味着您销毁了一个图层，但并未销毁其关联的handler。",
    ...
    'googleWarning': "Google图层不能正确加载。\x3cbr\x3e\x3cbr\x3e要消除这个信息，请在右上角的图层控制面板中选择其他的基础图层。\x3cbr\x3e\x3cbr\x3e这种情况很可能是没有正确的包含Google地图脚本库，或者是没有包含在你的站点上使用的正确的Google Maps API密匙。\x3cbr\x3e\x3cbr\x3e开发者：获取使其正确工作的帮助信息，\x3ca href=\'http://trac.openlayers.org/wiki/Google\' target=\'_blank\'\x3e点击这里\x3c/a\x3e",

    'getLayerWarning': "${layerType} 图层不能正确加载。\x3cbr\x3e\x3cbr\x3e要消除这个信息，请在右上角的图层控制面板中选择其他的基础图层。\x3cbr\x3e\x3cbr\x3e这种情况很可能是没有正确的包含${layerLib} 脚本库。\x3cbr\x3e\x3cbr\x3e开发者：获取使其正确工作的帮助信息，\x3ca href=\'http://trac.openlayers.org/wiki/${layerLib}\' target=\'_blank\'\x3e点击这里\x3c/a\x3e",
    ...
    'pagePositionFailed': "OpenLayers.Util.pagePosition 失败：id 为 ${elemId} 的元素可能被错置。",
