...
OpenLayers.Lang["hsb"] = OpenLayers.Util.applyDefaults({
    ...
    'boundsAddError': "Dyrbiš hódnotu x kaž tež y přepodać, zo by funkciju dodał.",

    'lonlatAddError': "Dyrbiš hódnotu lon kaž tež lat, zo by funkciju přidał.",

    'pixelAddError': "Dyrbiš hódnotu x kaž tež y přepodać, zo by funkciju přidał.",
