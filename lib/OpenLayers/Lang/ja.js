...
OpenLayers.Lang["ja"] = OpenLayers.Util.applyDefaults({
    ...
    'methodDeprecated': "このメソッドは廃止が予定されており、バージョン3.0で除去されます。代わりに ${newMethod} を使ってください。",

    'boundsAddError': "x と y の値両方を add 関数に渡さなければなりません。",

    'lonlatAddError': "lon と lat の値両方を add 関数に渡さなければなりません。",
