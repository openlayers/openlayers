...
ol.Map.prototype.getTilePriority =
  ...
  var frameState = this.frameState_;
  if (frameState === null || !(tileSourceKey in frameState.wantedTiles)) {
...
ol.Map.prototype.handleTargetChanged_ = function() {
  ...
  if (targetElement === null) {
    goog.dom.removeNode(this.viewport_);
    if (this.viewportResizeListenerKey_ !== null) {
    ...
    var keyboardEventTarget = this.keyboardEventTarget_ === null ?
...
ol.Map.prototype.handleViewChanged_ = function() {
  if (this.viewPropertyListenerKey_ !== null) {
...
ol.Map.prototype.handleLayerGroupChanged_ = function() {
  if (this.layerGroupPropertyListenerKeys_ !== null) {
...
ol.Map.prototype.renderFrame_ = function(time) {
  ...
  if (size !== undefined && ol.size.hasArea(size) &&
    ...
    frameState = /** @type {olx.FrameState} */ ({
      ...
      extent: null,
      focus: this.focus_ === null ? viewState.center : this.focus_,
