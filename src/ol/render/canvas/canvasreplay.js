  ...
  while (i < ii) {
    ...
    switch (type) {
      ...
      case ol.render.canvas.Instruction.SET_STROKE_STYLE:
        ...
        goog.asserts.assert(goog.isNumber(instruction[5]),
            '6th instruction should be a number');
        goog.asserts.assert(instruction[6] !== null,
...
ol.render.canvas.Replay.prototype.endGeometry = function(geometry, feature) {
  goog.asserts.assert(this.beginGeometryInstruction1_ !== null,
      'this.beginGeometryInstruction1_ should not be null');
  this.beginGeometryInstruction1_[2] = this.instructions.length;
  this.beginGeometryInstruction1_ = null;
  goog.asserts.assert(this.beginGeometryInstruction2_ !== null,
...
ol.render.canvas.ImageReplay.prototype.setImageStyle = function(imageStyle) {
  goog.asserts.assert(imageStyle !== null, 'imageStyle should not be null');
  var anchor = imageStyle.getAnchor();
  goog.asserts.assert(anchor !== null, 'anchor should not be null');
  var size = imageStyle.getSize();
  goog.asserts.assert(size !== null, 'size should not be null');
  var hitDetectionImage = imageStyle.getHitDetectionImage(1);
  goog.asserts.assert(hitDetectionImage !== null,
      'hitDetectionImage should not be null');
  var image = imageStyle.getImage(1);
  goog.asserts.assert(image !== null, 'image should not be null');
  var origin = imageStyle.getOrigin();
  goog.asserts.assert(origin !== null, 'origin should not be null');
...
ol.render.canvas.LineStringReplay.prototype.getBufferedMaxExtent = function() {
  if (this.bufferedMaxExtent_ === null) {
...
ol.render.canvas.LineStringReplay.prototype.setStrokeStyle_ = function() {
  ...
  goog.asserts.assert(lineDash !== null, 'lineDash should not be null');
...
ol.render.canvas.LineStringReplay.prototype.drawLineStringGeometry =
  ...
  var state = this.state_;
  goog.asserts.assert(state !== null, 'state should not be null');
  var strokeStyle = state.strokeStyle;
  var lineWidth = state.lineWidth;
...
ol.render.canvas.LineStringReplay.prototype.setFillStrokeStyle =
  ...
  goog.asserts.assert(this.state_ !== null, 'this.state_ should not be null');
  goog.asserts.assert(fillStyle === null, 'fillStyle should be null');
  goog.asserts.assert(strokeStyle !== null, 'strokeStyle should not be null');
  var strokeStyleColor = strokeStyle.getColor();
  this.state_.strokeStyle = ol.color.asString(strokeStyleColor !== null ?
      strokeStyleColor : ol.render.canvas.defaultStrokeStyle);
  var strokeStyleLineCap = strokeStyle.getLineCap();
  this.state_.lineCap = strokeStyleLineCap !== undefined ?
      strokeStyleLineCap : ol.render.canvas.defaultLineCap;
  var strokeStyleLineDash = strokeStyle.getLineDash();
  this.state_.lineDash = strokeStyleLineDash !== null ?
...
ol.render.canvas.PolygonReplay.prototype.setFillStrokeStyle =
    function(fillStyle, strokeStyle) {
  goog.asserts.assert(this.state_ !== null, 'this.state_ should not be null');
  goog.asserts.assert(fillStyle !== null || strokeStyle !== null,
      'fillStyle or strokeStyle should not be null');
  var state = this.state_;
  if (fillStyle !== null) {
    var fillStyleColor = fillStyle.getColor();
    state.fillStyle = ol.color.asString(fillStyleColor !== null ?
  ...
  if (strokeStyle !== null) {
    var strokeStyleColor = strokeStyle.getColor();
    state.strokeStyle = ol.color.asString(strokeStyleColor !== null ?
        strokeStyleColor : ol.render.canvas.defaultStrokeStyle);
    var strokeStyleLineCap = strokeStyle.getLineCap();
    state.lineCap = strokeStyleLineCap !== undefined ?
        strokeStyleLineCap : ol.render.canvas.defaultLineCap;
    var strokeStyleLineDash = strokeStyle.getLineDash();
    state.lineDash = strokeStyleLineDash !== null ?
...
ol.render.canvas.TextReplay.prototype.drawText =
  ...
  var fill = this.textFillState_ !== null;
  var stroke = this.textStrokeState_ !== null;
...
ol.render.canvas.TextReplay.prototype.setTextStyle = function(textStyle) {
  if (textStyle === null) {
    ...
    if (textFillStyle === null) {
      ...
      var fillStyle = ol.color.asString(textFillStyleColor !== null ?
    ...
    if (textStrokeStyle === null) {
      ...
      var strokeStyle = ol.color.asString(textStrokeStyleColor !== null ?
