...
/**
 * @param {import('../../style/flat.js').FlatStyleLike|import('./VectorStyleRenderer.js').StyleShaders|Array<import('./VectorStyleRenderer.js').StyleShaders>} style Single flat style
...
export function hasTextStyle(style) {
  ...
  if (Array.isArray(style)) {
    // if the style is made of shaders: no text
    if ('builder' in style[0]) {
      return false;
    }
