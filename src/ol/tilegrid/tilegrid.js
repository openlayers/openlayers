...
ol.tilegrid.TileGrid = function(options) {
  ...
  if (options.origins !== undefined) {
    ...
    ol.asserts.assert(this.origins_.length == this.resolutions_.length, 20); // Number of `origins` and `resolutions` must be equal
  }
  ...
  if (options.tileSizes !== undefined) {
    ...
    ol.asserts.assert(this.tileSizes_.length == this.resolutions_.length, 19); // Number of `tileSizes` and `resolutions` must be equal
  }
 ...
 * @api
 */
ol.tilegrid.TileGrid.prototype.forEachTileCoord = function(
  extent,
  zoom,
  callback
) {
 ...
 * @template T
 */
ol.tilegrid.TileGrid.prototype.forEachTileCoordParentTileRange = function(
  tileCoord,
  callback,
  opt_this,
  opt_tileRange,
 ...
 */
ol.tilegrid.TileGrid.prototype.getTileCoordChildTileRange = function(
  tileCoord,
  opt_tileRange,
  opt_extent
) {
 ...
 * @return {ol.Extent} Extent.
 */
ol.tilegrid.TileGrid.prototype.getTileRangeExtent = function(
  z,
  tileRange,
  opt_extent
) {
 ...
 * @api
 */
ol.tilegrid.TileGrid.prototype.getTileCoordExtent = function(
  tileCoord,
  opt_extent
) {
  var origin = this.getOrigin(tileCoord[0]);
...
ol.tilegrid.TileGrid.prototype.getZForResolution = function(
  ...
  var z = ol.array.linearFindNearest(
    this.resolutions_,
    resolution,
    opt_direction || 0
  );
