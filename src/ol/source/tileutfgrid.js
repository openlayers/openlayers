...
ol.source.TileUTFGrid.prototype.handleTileJSONResponse = function(tileJSON) {
  ...
  this.tileUrlFunction_ = ol.TileUrlFunction.createFromTemplates(
    grids,
    tileGrid
  );
 ...
 * @inheritDoc
 */
ol.source.TileUTFGrid.prototype.getTile = function(
  z,
  x,
  y,
  pixelRatio,
 ...
 * @private
 */
ol.source.TileUTFGrid.Tile_ = function(
  tileCoord,
  state,
  src,
  extent,
 ...
 * @template T
 */
ol.source.TileUTFGrid.Tile_.prototype.forDataAtCoordinate = function(
  coordinate,
  callback,
  opt_this,
  opt_request
