...
ol.source.WMTS.optionsFromCapabilities = function(wmtsCap, config) {
  ...
  // TODO: add support for TileMatrixLimits
  goog.asserts.assert(config['layer'] !== null,
  ...
  goog.asserts.assert(l !== null, 'found a matching layer in Contents/Layer');
  ...
  goog.asserts.assert(matrixSet !== null, 'TileMatrixSet must not be null');
  ...
  goog.asserts.assert(matrixSetObj !== null,
