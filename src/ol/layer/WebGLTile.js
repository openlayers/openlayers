...
class WebGLTileLayer extends BaseTileLayer {
  ...
  /**
   * @return {ParsedStyle} uniforms, pipelines, and others generated from the style.
   */
  parseStyle() {
    ...
    const uniformDeclarations = Object.keys(uniforms).map(
  ...
  /**
   * @param {ParsedStyle} style Style to apply to the layer.
  ...
  buildShaders(style) {
    ...
    const fragmentShader = `
      ...
      ${style.uniformDeclarations.join('\n')}
      ${style.functionDefintions.join('\n')}
