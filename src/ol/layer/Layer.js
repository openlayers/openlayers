 ...
 *
 * Layers are usually added to a map with {@link module:ol/PluggableMap#addLayer}. Components
 ...
 * {@link module:ol/PluggableMap#forEachLayerAtPixel} will receive `null` as layer. This
 * is useful for temporary layers. To remove an unmanaged layer from the map,
 * use `#setMap(null)`.
 *
 * To add the layer to a map and have it managed by the map, use
 * {@link module:ol/PluggableMap#addLayer} instead.
