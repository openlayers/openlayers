...
if (ol.ENABLE_WEBGL) {
  ...
  ol.renderer.webgl.defaultmapshader.Fragment = function() {
    ol.webgl.Fragment.call(
      this,
      ol.renderer.webgl.defaultmapshader.Fragment.SOURCE
    );
  };
  ...
  ol.renderer.webgl.defaultmapshader.fragment = new ol.renderer.webgl
    .defaultmapshader.Fragment();
  ...
  ol.renderer.webgl.defaultmapshader.Vertex = function() {
    ol.webgl.Vertex.call(
      this,
      ol.renderer.webgl.defaultmapshader.Vertex.SOURCE
    );
  };
  ...
  ol.renderer.webgl.defaultmapshader.vertex = new ol.renderer.webgl
    .defaultmapshader.Vertex();
  ...
  ol.renderer.webgl.defaultmapshader.Locations = function(gl, program) {
    ...
    this.u_projectionMatrix = gl.getUniformLocation(
      program,
      ol.DEBUG_WEBGL ? 'u_projectionMatrix' : 'e'
    );
    ...
    this.u_texCoordMatrix = gl.getUniformLocation(
      program,
      ol.DEBUG_WEBGL ? 'u_texCoordMatrix' : 'd'
    );
