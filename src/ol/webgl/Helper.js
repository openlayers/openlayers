...
class WebGLHelper extends Disposable {
   ...
   * Will have no effect if `enableInstancedAttributes` was not called for this rendering pass.
   * @param {number} start Start index.
   * @param {number} end End index.
  ...
  enableAttributeArray_(attribName, size, type, stride, offset, instanced) {
    ...
    if (instanced) {
      ...
      // TODO: only do this if doing instanced rendering
      // this.getInstancedRenderingExtension_().vertexAttribDivisorANGLE(
      //   location,
      //   0,
      // );
   ...
   * @param {Array<AttributeDescription>} attributes Ordered list of attributes to read from the buffer
   */
  enableInstancedAttributes(attributes) {
