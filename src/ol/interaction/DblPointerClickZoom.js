/**
 * @module ol/interaction/DblPointerClickZoom
 */
 ...
 * @property {number} [delta=1] The zoom delta applied on each double pointer click.
 ...
 * @api
 */
class DblPointerClickZoom extends Interaction {
  /**
...
export default DblPointerClickZoom;
