...
ol.format.GML3.prototype.readSurface_ = function(node, objectStack) {
  ...
  if (flatLinearRings && flatLinearRings[0] !== null) {
...
ol.format.GML3.prototype.readFlatPosList_ = function(node, objectStack) {
  ...
  var dim = 2;
  if (node.getAttribute('srsDimension') !== null) {
    dim = ol.format.XSD.readNonNegativeIntegerString(
        node.getAttribute('srsDimension'));
  } else if (node.getAttribute('dimension') !== null) {
    dim = ol.format.XSD.readNonNegativeIntegerString(
        node.getAttribute('dimension'));
  } else if (containerDimension !== null) {
