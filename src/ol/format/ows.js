...
ol.format.OWS.readAddress_ = function(node, objectStack) {
  return ol.xml.pushParseAndPop(
    {},
    ol.format.OWS.ADDRESS_PARSERS_,
    node,
    objectStack
  );
};
...
ol.format.OWS.readAllowedValues_ = function(node, objectStack) {
  return ol.xml.pushParseAndPop(
    {},
    ol.format.OWS.ALLOWED_VALUES_PARSERS_,
    node,
    objectStack
  );
};
...
ol.format.OWS.readConstraint_ = function(node, objectStack) {
  ...
  return ol.xml.pushParseAndPop(
    {name: name},
    ol.format.OWS.CONSTRAINT_PARSERS_,
    node,
    objectStack
  );
};
...
ol.format.OWS.readContactInfo_ = function(node, objectStack) {
  return ol.xml.pushParseAndPop(
    {},
    ol.format.OWS.CONTACT_INFO_PARSERS_,
    node,
    objectStack
  );
};
...
ol.format.OWS.readGet_ = function(node, objectStack) {
  ...
  return ol.xml.pushParseAndPop(
    {href: href},
    ol.format.OWS.REQUEST_METHOD_PARSERS_,
    node,
    objectStack
  );
};
...
ol.format.OWS.readOperation_ = function(node, objectStack) {
  ...
  var value = ol.xml.pushParseAndPop(
    {},
    ol.format.OWS.OPERATION_PARSERS_,
    node,
    objectStack
  );
  if (!value) {
...
ol.format.OWS.readOperationsMetadata_ = function(node, objectStack) {
  return ol.xml.pushParseAndPop(
    {},
    ol.format.OWS.OPERATIONS_METADATA_PARSERS_,
    node,
    objectStack
  );
};
 ...
 * @private
 */
ol.format.OWS.PARSERS_ = ol.xml.makeStructureNS(ol.format.OWS.NAMESPACE_URIS_, {
...
ol.format.OWS.ADDRESS_PARSERS_ = ol.xml.makeStructureNS(
  ...
  {
    DeliveryPoint: ol.xml.makeObjectPropertySetter(ol.format.XSD.readString),
...
ol.format.OWS.REQUEST_METHOD_PARSERS_ = ol.xml.makeStructureNS(
  ol.format.OWS.NAMESPACE_URIS_,
  {
    Constraint: ol.xml.makeObjectPropertyPusher(ol.format.OWS.readConstraint_)
  }
);
 ...
 * @private
 */
ol.format.OWS.SERVICE_CONTACT_PARSERS_ = ol.xml.makeStructureNS(
  ol.format.OWS.NAMESPACE_URIS_,
  {
    IndividualName: ol.xml.makeObjectPropertySetter(ol.format.XSD.readString),
    PositionName: ol.xml.makeObjectPropertySetter(ol.format.XSD.readString),
    ContactInfo: ol.xml.makeObjectPropertySetter(ol.format.OWS.readContactInfo_)
  }
);
 ...
 * @private
 */
ol.format.OWS.SERVICE_IDENTIFICATION_PARSERS_ = ol.xml.makeStructureNS(
  ol.format.OWS.NAMESPACE_URIS_,
  {
 ...
 * @private
 */
ol.format.OWS.SERVICE_PROVIDER_PARSERS_ = ol.xml.makeStructureNS(
  ol.format.OWS.NAMESPACE_URIS_,
  {
