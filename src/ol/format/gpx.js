 ...
 */
ol.format.GPX.appendCoordinate_ = function(
  flatCoordinates,
  layoutOptions,
  node,
  values
 ...
 */
ol.format.GPX.applyLayoutOptions_ = function(
  layoutOptions,
  flatCoordinates,
  ends
) {
...
ol.format.GPX.parseRtePt_ = function(node, objectStack) {
  ...
  if (values) {
    ...
    ol.format.GPX.appendCoordinate_(
      flatCoordinates,
      layoutOptions,
      node,
      values
...
ol.format.GPX.readRte_ = function(node, objectStack) {
  ...
  var layout = ol.format.GPX.applyLayoutOptions_(
    layoutOptions,
    flatCoordinates
  );
...
ol.format.GPX.readWpt_ = function(node, objectStack) {
  ...
  var layoutOptions /** @type {ol.LayoutOptions} */ = {};
  var coordinates = ol.format.GPX.appendCoordinate_(
    [],
    layoutOptions,
    node,
    values
...
ol.format.GPX.RTE_PARSERS_ = ol.xml.makeStructureNS(
  ol.format.GPX.NAMESPACE_URIS_,
  {
    ...
    number: ol.xml.makeObjectPropertySetter(
...
ol.format.GPX.WPT_PARSERS_ = ol.xml.makeStructureNS(
  ol.format.GPX.NAMESPACE_URIS_,
  {
    ...
    dgpsid: ol.xml.makeObjectPropertySetter(
      ol.format.XSD.readNonNegativeInteger
    ),
    extensions: ol.format.GPX.parseExtensions_
  }
...
ol.format.GPX.writeRte_ = function(node, feature, objectStack) {
  ...
  if (geometry) {
    geometry /** @type {ol.geom.LineString} */ = ol.format.Feature.transformWithOptions(
      geometry,
      true,
      options
    );
...
ol.format.GPX.writeTrk_ = function(node, feature, objectStack) {
  ...
  var geometry = feature.getGeometry();
  if (geometry) {
    geometry /** @type {ol.geom.MultiLineString} */ = ol.format.Feature.transformWithOptions(
      geometry,
      true,
      options
    );
...
ol.format.GPX.writeTrkSeg_ = function(node, lineString, objectStack) {
  ...
  ol.xml.pushSerializeAndPop(
    ...
    ol.format.GPX.TRKSEG_NODE_FACTORY_,
...
ol.format.GPX.writeWpt_ = function(node, feature, objectStack) {
  ...
  var geometry = feature.getGeometry();
  if (geometry) {
    geometry /** @type {ol.geom.Point} */ = ol.format.Feature.transformWithOptions(
      geometry,
      true,
      options
    );
...
ol.format.GPX.TRK_SERIALIZERS_ = ol.xml.makeStructureNS(
  ol.format.GPX.NAMESPACE_URIS_,
  {
    ...
    trkseg: ol.xml.makeArraySerializer(
      ol.xml.makeChildAppender(ol.format.GPX.writeTrkSeg_)
    )
  }
);
...
ol.format.GPX.prototype.writeFeaturesNode = function(features, opt_options) {
  ...
  ol.xml.pushSerializeAndPop(
    ...
    ol.format.GPX.GPX_NODE_FACTORY_,
    features,
    [opt_options]
  );
  return gpx;
