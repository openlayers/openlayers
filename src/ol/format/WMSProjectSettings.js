/**
 * @module ol/format/WMSProjectSettings
 */
...
/**
 * @classdesc
 * Format for reading WMS capabilities data from QGIS
 *
 * @api
 */
class WMSProjectSettings extends XML {
  constructor() {
    super();
...
function readLayer(node, objectStack) {
  ...
  let visible = readBooleanString(node.getAttribute('visible'));
  if (visible === undefined) {
    visible = parentLayerObject['visible'];
  }
  layerObject['visible'] = visible !== undefined ? visible : false;
...
export default WMSProjectSettings;
