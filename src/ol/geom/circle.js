 ...
 * @inheritDoc
 */
ol.geom.Circle.prototype.closestPointXY = function(
  x,
  y,
  closestPoint,
  minSquaredDistance
 ...
 * @api
 */
ol.geom.Circle.prototype.setCenterAndRadius = function(
  center,
  radius,
  opt_layout
) {
 ...
 */
ol.geom.Circle.prototype.setFlatCoordinates = function(
  layout,
  flatCoordinates
) {
