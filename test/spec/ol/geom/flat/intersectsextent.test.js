...
describe('ol.geom.flat.intersectsextent', () => {

  describe('ol.geom.flat.intersectsextent.intersectsLineString', () => {
    let flatCoordinates;
    beforeEach(() => {
      flatCoordinates = [0, 0, 1, 1, 2, 2];
    });
    describe('linestring envelope does not intersect the extent', () => {
      test('returns false', () => {
    ...
    describe('linestring envelope within the extent', () => {
      test('returns true', () => {
    ...
    describe('a segment intersects the extent', () => {
      test('returns true', () => {
    ...
    describe('no segments intersect the extent', () => {
      test('returns false', () => {
  ...
  describe('ol.geom.flat.intersectsextent.intersectsLinearRing', () => {
    let flatCoordinates;
    beforeEach(() => {
      flatCoordinates = [0, 0, 1, 1, 2, 0, 1, -1, 0, 0];
    });
    describe('boundary intersects the extent', () => {
      test('returns true', () => {
    ...
    describe('ring contains the extent', () => {
      test('returns true', () => {
  ...
  describe('ol.geom.flat.intersectsextent.intersectsLinearRingArray', () => {
    let flatCoordinates;
    let ends;
    beforeEach(() => {
    ...
    describe('ring with hole where hole contains the extent', () => {
      test('returns true', () => {
    ...
    describe('ring with hole intersects the extent', () => {
      test('returns true', () => {
