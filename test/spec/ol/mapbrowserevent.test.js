...
describe('ol.MapBrowserEventHandler', function() {
  describe('#emulateClick_', function() {
    ...
    beforeEach(function() {
      ...
      handler = new ol.MapBrowserEventHandler(
        new ol.Map({
          target: target
        })
      );
  ...
  describe('#isMoving_', function() {
    ...
    beforeEach(function() {
      ...
      pointerdownAt0 = new ol.pointer.PointerEvent(
        'pointerdown',
        {},
        {
          clientX: 0,
    ...
    it('is not moving if distance is 0', function() {
      var pointerdownAt0 = new ol.pointer.PointerEvent(
        'pointerdown',
        {},
        {
          clientX: 0,
    ...
    it('is moving if distance is 2', function() {
      var pointerdownAt2 = new ol.pointer.PointerEvent(
        'pointerdown',
        {},
        {
    ...
    it('is moving if distance is greater than move tolerance', function() {
      var pointerdownAt9 = new ol.pointer.PointerEvent(
        'pointerdown',
        {},
        {
