...
describe('ol.format.EsriJSON', function() {
  ...
  var polygonEsriJSON = {
    geometry: {
      rings: [[[100.0, 0.0], [100.0, 1.0], [101.0, 1.0], [101.0, 0.0]]]
    },
    attributes: {
      prop0: 'value0',
      prop1: {this: 'that'}
  ...
  var data = {
    features: [
      ...
      },
      {
        ...
        geometry: {
          paths: [[[1549754.2769, 6403854.8024], [1549728.45985, 6403920.2]]]
        }
      }
    ]
  };
  ...
  describe('#readFeature', function() {
    ...
    it('can create a feature with a specific geometryName', function() {
      var feature = new ol.format.EsriJSON({
  ...
  describe('#readFeatures', function() {
    ...
    it('parses ksfields.geojson', function(done) {
      afterLoadText('spec/ol/format/esrijson/ksfields.json', function(text) {
        ...
        expect(
          ol.extent.equals(firstGeom.getExtent(), [
            -10585772.743554419,
            4712365.161160459,
            -10579560.16462974,
            4716567.373073828
        ...
        expect(
          ol.extent.equals(lastGeom.getExtent(), [
            -10555714.026858449,
            4576511.565880965,
            -10553671.199322715,
            4578554.9934867555
  ...
  describe('#writeGeometry', function() {
    ...
    it('encodes XYZM point', function() {
      var point = new ol.geom.Point([10, 20, 5, 0], 'XYZM');
      var esrijson = format.writeGeometry(point);
      expect(point.getCoordinates()).to.eql(
        format.readGeometry(esrijson).getCoordinates()
      );
    ...
    it('encodes XYZ polygon', function() {
      ...
      var inner1 = [[1, 1, 3], [2, 1, 3], [2, 2, 3], [1, 2, 3], [1, 1, 3]];
      var inner2 = [[8, 8, 2], [9, 8, 2], [9, 9, 2], [8, 9, 2], [8, 8, 2]];
      var polygon = new ol.geom.Polygon([outer, inner1, inner2], 'XYZ');
      var esrijson = format.writeGeometry(polygon);
      expect(polygon.getCoordinates(false)).to.eql(
        format.readGeometry(esrijson).getCoordinates()
      );
    ...
    it('encodes XYM polygon', function() {
      ...
      var inner1 = [[1, 1, 3], [2, 1, 3], [2, 2, 3], [1, 2, 3], [1, 1, 3]];
      var inner2 = [[8, 8, 2], [9, 8, 2], [9, 9, 2], [8, 9, 2], [8, 8, 2]];
      var polygon = new ol.geom.Polygon([outer, inner1, inner2], 'XYM');
      var esrijson = format.writeGeometry(polygon);
      expect(polygon.getCoordinates(false)).to.eql(
        format.readGeometry(esrijson).getCoordinates()
      );
    ...
    it('encodes XYZM polygon', function() {
      ...
      var polygon = new ol.geom.Polygon([outer, inner1, inner2], 'XYZM');
      var esrijson = format.writeGeometry(polygon);
      expect(polygon.getCoordinates(false)).to.eql(
        format.readGeometry(esrijson).getCoordinates()
      );
      ...
      var multipolygon = new ol.geom.MultiPolygon(
        [
          [
            ...
            [[2, 2, 0, 3], [3, 2, 0, 4], [3, 3, 0, 1], [2, 3, 0, 1]]
          ],
