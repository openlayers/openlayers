  ...
  describe('without parameters', function() {
    ...
    describe('#readFeatures', function() {
      ...
      describe('geometry', function() {
        ...
        it('can transform and read Point geometries', function() {
          ...
          var g = f.getGeometry();
          expect(g).to.be.an(ol.geom.Point);
          var expectedPoint = ol.proj.transform(
            [1, 2],
            'EPSG:4326',
            'EPSG:3857'
          );
        ...
        it("can read a IconStyle's hotspot", function() {
          ...
          fs.forEach(function(f) {
            ...
            if (f.getId() == 1) {
              ...
              expect(imageStyle.anchorOrigin_).to.be(
                ol.style.IconOrigin.BOTTOM_LEFT
              );
              expect(imageStyle.anchorXUnits_).to.be(
                ol.style.IconAnchorUnits.FRACTION
              );
              expect(imageStyle.anchorYUnits_).to.be(
                ol.style.IconAnchorUnits.FRACTION
              );
            } else {
    ...
    describe('#readNetworkLinks', function() {
      ...
      it('returns an array of network links', function() {
        ...
        expect(nl[0].href.replace(window.location.href, '')).to.be(
          'bar/bar.kml'
        );
