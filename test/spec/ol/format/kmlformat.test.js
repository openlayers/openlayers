  ...
  describe('#readFeatures', function() {
    ...
    describe('styles', function() {
      ...
      it('applies the default style if no style is defined', function() {
        ...
        expect(style.fill).to.be(ol.format.KML.DEFAULT_FILL_STYLE_);
        expect(style.fill.color).to.eql([255, 255, 255, 1]);
        expect(style.image).to.be(ol.format.KML.DEFAULT_IMAGE_STYLE_);
        // FIXME check image style
        expect(style.stroke).to.be(ol.format.KML.DEFAULT_STROKE_STYLE_);
        expect(style.stroke.color).to.eql([255, 255, 255, 1]);
        expect(style.stroke.width).to.be(1);
      });
      ...
      it('can read a feature\'s LineStyle', function() {
        ...
        expect(strokeStyle.color).to.eql([0x78, 0x56, 0x34, 0x12 / 255]);
        expect(strokeStyle.width).to.be(9);
        expect(style.text).to.be(null);
        expect(style.zIndex).to.be(undefined);
      });
      ...
      it('can read a feature\'s PolyStyle', function() {
        ...
        expect(fillStyle.color).to.eql([0x78, 0x56, 0x34, 0x12 / 255]);
        expect(style.image).to.be(ol.format.KML.DEFAULT_IMAGE_STYLE_);
        expect(style.stroke).to.be(ol.format.KML.DEFAULT_STROKE_STYLE_);
        expect(style.text).to.be(null);
        expect(style.zIndex).to.be(undefined);
