...
describe('ol.proj', function() {
  ...
  describe('identify transform', function() {
    it('returns a new object, with same coord values', function() {
      ...
      var destinationPoint = ol.proj.transform(sourcePoint, epsg4326, epsg4326);
  ...
  describe('Proj4js integration', function() {
    ...
    it('numerically estimates point scale at the equator', function() {
      ...
      expect(
        ol.proj.getPointResolution(googleProjection, 1, [0, 0])
    ...
    it('numerically estimates point scale at various latitudes', function() {
      ...
      for (y = -20; y <= 20; ++y) {
        point = [0, 1000000 * y];
        expect(
          ol.proj.getPointResolution(googleProjection, 1, point)
        ).to.roughlyEqual(
          ol.proj.getPointResolution(epsg3857Projection, 1, point),
          1e-1
        );
      }
    });
