...
describe('ol.render.webgl.LineStringReplay', function() {
  ...
  describe('#drawLineString', function() {
    it('sets the buffer data', function() {
      ...
      linestring = new ol.geom.LineString([[1000, 2000], [2000, 3000]]);
      replay.setFillStrokeStyle(null, strokeStyle1);
  ...
  describe('#drawCoordinates_', function() {
    it('triangulates linestrings', function() {
      ...
      replay.drawCoordinates_(flatCoordinates, 0, flatCoordinates.length, 2);
    ...
    it('closes boundaries', function() {
      ...
      expect(replay.vertices.slice(14, 21)).to.eql(replay.vertices.slice(-7));
    });
  });
    ...
    it('gets and compiles the shaders', function() {
      ...
      expect(
        context.getProgram.calledWithExactly(
          ...
          ol.render.webgl.linestringreplay.defaultshader.vertex
        )
      ).to.be(true);
