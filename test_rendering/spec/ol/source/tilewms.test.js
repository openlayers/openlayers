  ...
  describe('0px gutter, 1 pixel ratio', function() {
    it('tests the canvas renderer', function(done) {
      ...
      tilesLoaded(source, function() {
        expectResemble(
          map,
          'spec/ol/source/expected/0_1.canvas.png',
          IMAGE_TOLERANCE,
          done
        );
      });
    ...
    it('tests the WebGL renderer', function(done) {
      ...
      tilesLoaded(source, function() {
        expectResemble(
          map,
          'spec/ol/source/expected/0_1.webgl.png',
          IMAGE_TOLERANCE,
          done
        );
      });
  ...
  describe('0px gutter, 2 pixel ratio', function() {
    it('tests the canvas renderer', function(done) {
      ...
      tilesLoaded(source, function() {
        expectResemble(
          map,
          'spec/ol/source/expected/0_2.canvas.png',
          IMAGE_TOLERANCE,
          done
        );
      });
    ...
    it('tests the WebGL renderer', function(done) {
      ...
      tilesLoaded(source, function() {
        expectResemble(
          map,
          'spec/ol/source/expected/0_2.webgl.png',
          IMAGE_TOLERANCE,
          done
        );
      });
  ...
  describe('20px gutter, 1 pixel ratio', function() {
    it('tests the canvas renderer', function(done) {
      ...
      tilesLoaded(source, function() {
        expectResemble(
          map,
          'spec/ol/source/expected/20_1.canvas.png',
          IMAGE_TOLERANCE,
          done
        );
      });
    ...
    it('tests the WebGL renderer', function(done) {
      ...
      tilesLoaded(source, function() {
        expectResemble(
          map,
          'spec/ol/source/expected/20_1.webgl.png',
          IMAGE_TOLERANCE,
          done
        );
      });
  ...
  describe('20px gutter, 2 pixel ratio', function() {
    it('tests the canvas renderer', function(done) {
      ...
      tilesLoaded(source, function() {
        expectResemble(
          map,
          'spec/ol/source/expected/20_2.canvas.png',
          IMAGE_TOLERANCE,
          done
        );
      });
    ...
    it('tests the WebGL renderer', function(done) {
      ...
      tilesLoaded(source, function() {
        expectResemble(
          map,
          'spec/ol/source/expected/20_2.webgl.png',
          IMAGE_TOLERANCE,
          done
        );
      });
