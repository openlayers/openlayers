  ...
  describe('different strokes', function() {
    ...
    function createFeatures() {
      ...
      feature = new ol.Feature({
        geometry: new ol.geom.LineString([[-20, 20], [15, 20]])
      });
      feature.setStyle(
        new ol.style.Style({
      ...
      feature = new ol.Feature({
        geometry: new ol.geom.LineString([[-20, 15], [15, 15]])
      });
      feature.setStyle(
        new ol.style.Style({
      ...
      feature = new ol.Feature({
        geometry: new ol.geom.LineString([[-20, 10], [15, 10]])
      });
      feature.setStyle([
        new ol.style.Style({
      ...
      feature = new ol.Feature({
        geometry: new ol.geom.LineString([[-20, -20], [-2, 0], [15, -20]])
      });
      feature.setStyle(
        new ol.style.Style({
      ...
      feature = new ol.Feature({
        geometry: new ol.geom.LineString([[-20, -15], [-2, 5], [15, -15]])
      });
      feature.setStyle(
        new ol.style.Style({
          stroke: new ol.style.Stroke({
    ...
    it('tests the canvas renderer', function(done) {
      ...
      expectResemble(
        map,
        'spec/ol/style/expected/linestring-strokes-canvas.png',
        3.0,
        done
      );
    });
    it('tests the WebGL renderer', function(done) {
      ...
      expectResemble(
        map,
        'spec/ol/style/expected/linestring-strokes-webgl.png',
        14.6,
        done
      );
    });
    ...
    it('tests the canvas renderer (HiDPI)', function(done) {
      ...
      expectResemble(
        map,
        'spec/ol/style/expected/linestring-strokes-canvas-hidpi.png',
        3.0,
        done
      );
    });
