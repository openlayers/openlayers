  ...
  describe('single tile layer', function() {
    ...
    it('tests the canvas renderer', function(done) {
      ...
      waitForTiles([source], {}, function() {
        expectResemble(
          map,
          'spec/ol/layer/expected/osm-canvas.png',
          IMAGE_TOLERANCE,
          done
        );
      });
    ...
    it('tests the WebGL renderer', function(done) {
      ...
      waitForTiles([source], {}, function() {
        expectResemble(
          map,
          'spec/ol/layer/expected/osm-webgl.png',
          IMAGE_TOLERANCE,
          done
        );
      });
  ...
  describe('two tile layers', function() {
    ...
    it('tests the canvas renderer', function(done) {
      ...
      waitForTiles([source1, source2], {}, function() {
        expectResemble(
          map,
          'spec/ol/layer/expected/2-layers-canvas.png',
          IMAGE_TOLERANCE,
          done
        );
      });
    ...
    it('tests the WebGL renderer', function(done) {
      ...
      waitForTiles([source1, source2], {}, function() {
        expectResemble(
          map,
          'spec/ol/layer/expected/2-layers-webgl.png',
          IMAGE_TOLERANCE,
          done
        );
      });
    ...
    it('tests canvas layer extent clipping', function(done) {
      ...
      waitForTiles(
        [source1, source2],
        [{}, {extent: centerExtent(map)}],
        function() {
          expectResemble(
            map,
            'spec/ol/layer/expected/2-layers-canvas-extent.png',
            IMAGE_TOLERANCE,
            done
          );
        }
    ...
    it('tests canvas layer extent clipping with rotation', function(done) {
      ...
      waitForTiles(
        ...
        function() {
          expectResemble(
            map,
            'spec/ol/layer/expected/2-layers-canvas-extent-rotate.png',
            IMAGE_TOLERANCE,
            done
          );
        }
    ...
    it('tests canvas layer extent clipping (HiDPI)', function(done) {
      ...
      waitForTiles(
        ...
        function() {
          expectResemble(
            map,
            'spec/ol/layer/expected/2-layers-canvas-extent-hidpi.png',
            IMAGE_TOLERANCE,
            done
          );
        }
    ...
    it('tests canvas layer extent clipping with rotation (HiDPI)', function(
      done
    ) {
      map = createMap('canvas', undefined, undefined, 2);
      map.getView().setRotation(Math.PI / 2);
      waitForTiles(
        ...
        function() {
          expectResemble(
            map,
            'spec/ol/layer/expected/2-layers-canvas-extent-rotate-hidpi.png',
            IMAGE_TOLERANCE,
            done
          );
        }
  ...
  describe('tile layer with opacity', function() {
    ...
    it('tests the canvas renderer', function(done) {
      ...
      waitForTiles([source], {opacity: 0.2}, function() {
        expectResemble(
          map,
          'spec/ol/layer/expected/opacity-canvas.png',
          IMAGE_TOLERANCE,
          done
        );
      });
    ...
    it('tests the WebGL renderer', function(done) {
      ...
      waitForTiles([source], {opacity: 0.2}, function() {
        expectResemble(
          map,
          'spec/ol/layer/expected/opacity-webgl.png',
          IMAGE_TOLERANCE,
          done
        );
      });
  ...
  describe('tile layer with non-square tiles', function() {
    ...
    it('512x256 renders correcly using the canvas renderer', function(done) {
      ...
      waitForTiles([source], {}, function() {
        expectResemble(
          map,
          'spec/ol/layer/expected/512x256-canvas.png',
          IMAGE_TOLERANCE,
          done
        );
      });
    ...
    it('512x256 renders correcly using the webgl renderer', function(done) {
      ...
      waitForTiles([source], {}, function() {
        expectResemble(
          map,
          'spec/ol/layer/expected/512x256-webgl.png',
          IMAGE_TOLERANCE,
          done
        );
      });
    ...
    it('192x256 renders correcly using the canvas renderer', function(done) {
      ...
      waitForTiles([source], {}, function() {
        expectResemble(
          map,
          'spec/ol/layer/expected/192x256-canvas.png',
          IMAGE_TOLERANCE,
          done
        );
      });
    ...
    it('192x256 renders correcly using the webgl renderer', function(done) {
      ...
      waitForTiles([source], {}, function() {
        expectResemble(
          map,
          'spec/ol/layer/expected/192x256-webgl.png',
          IMAGE_TOLERANCE,
          done
        );
      });
  ...
  describe('tile layer with render listener', function() {
    ...
    it('works with the canvas renderer', function(done) {
      ...
      waitForTiles([source], {}, function() {
        expectResemble(
          map,
          'spec/ol/layer/expected/render-canvas.png',
          IMAGE_TOLERANCE,
          done
        );
      });
