...
describe('ol.rendering.reproj.Tile', function() {
  function testSingleTile(
    ...
    var tile = new ol.reproj
      .Tile(
      sourceProjection,
      source.getTileGrid(),
      ol.proj.get(targetProjection),
      targetTileGrid,
      [z, x, y],
      null,
      pixelRatio,
  ...
  describe('single tile reprojections from EPSG:3857', function() {
    ...
    it('works for identity reprojection', function(done) {
      testSingleTile(
        ...
        -13,
        1,
        'spec/ol/data/tiles/osm/5/5/12.png',
        1,
        done
      );
    });
    ...
    it('to EPSG:4326', function(done) {
      ...
      testSingleTile(
        ...
        -20,
        1,
        'spec/ol/reproj/expected/osm4326.png',
        1,
        done
      );
    });
    ...
    it('to ESRI:54009', function(done) {
      ...
      testSingleTile(
        ...
        -16,
        1,
        'spec/ol/reproj/expected/osm54009.png',
        1,
        done
      );
    });
  ...
  describe('stitching several tiles from EPSG:3857', function() {
    ...
    it('to EPSG:4326', function(done) {
      ...
      testSingleTile(
        ...
        -21,
        1,
        'spec/ol/reproj/expected/stitch-osm4326.png',
        2,
        done
      );
    });
    ...
    it('to EPSG:3740', function(done) {
      ...
      testSingleTile(
        ...
        -13,
        1,
        'spec/ol/reproj/expected/stitch-osm3740.png',
        4,
        done
      );
    });
  ...
  describe('tile projection from EPSG:4326', function() {
    ...
    it('works for identity reprojection', function(done) {
      testSingleTile(
        ...
        -1,
        1,
        'spec/ol/data/tiles/4326/0/0/0.png',
        1,
        done
      );
    });
    ...
    it('to EPSG:3857', function(done) {
      ...
      testSingleTile(
        ...
        -1,
        1,
        'spec/ol/reproj/expected/4326-to-3857.png',
        1,
        done
      );
    });
  ...
  describe('non-square source tiles', function() {
    ...
    it('works for identity reprojection', function(done) {
      testSingleTile(
        ...
        -13,
        1,
        'spec/ol/data/tiles/osm-512x256/5/3/12.png',
        1,
        done
      );
    });
    ...
    it('to 64x128 EPSG:4326', function(done) {
      ...
      testSingleTile(
        ...
        -10,
        1,
        'spec/ol/reproj/expected/512x256-to-64x128.png',
        1,
        done
      );
    });
  ...
  describe('dateline wrapping', function() {
    ...
    it('wraps X when prime meridian is shifted', function(done) {
      ...
      proj_.setExtent([-20026376.39, -20048966.1, 20026376.39, 20048966.1]);
      ...
      testSingleTile(
        ...
        -1,
        1,
        'spec/ol/reproj/expected/dateline-merc-180.png',
        2,
        done
      );
    });
    ...
    it('displays north pole correctly (EPSG:3413)', function(done) {
      ...
      testSingleTile(
        ...
        -1,
        1,
        'spec/ol/reproj/expected/dateline-pole.png',
        2,
        done
      );
    });
