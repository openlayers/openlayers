 ...
 * field and it is bound to the prerender event of the layers.
 *
 ...
 * 'source-over' and it is bound to the postrender event of the layers.
 *
 * @param {module:ol/render/Event~RenderEvent} evt The render event.
 */
...
/**
 * Bind the pre- and postrender handlers to the passed layer.
 *
...
/**
 * Unbind the pre- and postrender handlers to the passed layers.
 *
